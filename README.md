...
| 4 | [WTWR — Front End](https://github.com/cmarsee-blip/se_project_react) | "What to Wear?" — a React app that recommends outfits based on real-time weather data for the user's location. | React, Vite, OpenWeatherAPI | — *(no live demo yet — consider enabling GitHub Pages)* |
